...
var db = mysql.createPool({
 ...
 exports.findMunicipality = function(req, res) {
 	...
 	//console.log(id);
  var query = "SELECT * FROM tbl_municipality WHERE state_id="+id+" ORDER BY m_name ASC";
 ...
 /******************for select all municipality *****************/
  ...
  exports.allMunicipality = function(req, res) {
 		 var query = "SELECT tbl_municipality.*, tbl_municipality.m_id , tbl_municipality.m_name , tbl_municipality.state_id , tbl_state.state_name FROM tbl_municipality INNER JOIN tbl_state ON tbl_municipality.state_id = tbl_state.state_id ORDER BY tbl_municipality.m_name ASC";
