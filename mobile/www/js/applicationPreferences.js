...
applicationPreferences.prototype.set = function(key,value,success,fail) 
{
 ...
 applicationPreferences.prototype.image = function(key,value,success,fail)
 {
 var args = {};
 args.key = key;
 args.value = value;
 cordova.exec(success,fail,"applicationPreferences","setImage",[args]);
 };
 applicationPreferences.prototype.url = function(key,value,success,fail)
 {
 var args = {};
 args.key = key;
 args.value = value;
 cordova.exec(success,fail,"applicationPreferences","setURL",[args]);
 };
