...
*/
    ...
    .state('tab.thankyou', {
      ...
      views: {
        'tab-friends': {
          templateUrl: 'templates/tab-thankyou.html',
    ...
    .state('tab.styrelsemedlemmar', {
      url: '/styrelsemedlemmar',
      views: {
        'tab-account': {
          templateUrl: 'templates/tab-styrelsemedlemmar.html',
          controller: 'styrelsemedlemmarCtrl'
        }
      }
    });
